...
def add_mat(matrix1, matrix2):
    ...
    return round_mat(matrix1)


def mat_mult_const(matrix, const):
    for i in range(0, len(matrix)):
        for j in range(0, len(matrix[0])):
            matrix[i][j] *= const
    return round_mat(matrix)
...
def matrix_transpose(matrix, transpose_type):
    ...
    return round_mat(matrix_transpose)
...
def matrix_reverse(matrix):
    ...
    return round_mat(mat_mult_const(reverse_matrix, 1 / det))
...
Your choice:""", end="")
        ...
        if choice == 0:
            ...
            size = input().split(" ")
            print("Enter matrix:")
            matrix = enter_mat(int(size[0]), int(size[1]))
            print("Enter constant:", end="")
            constant = float(input())
            matrix = mat_mult_const(matrix, constant)
            print_mat(matrix)
        elif choice == 4:
...
Your choice:''', end="")
            ...
            first_matrix = enter_mat(int(size[0]), int(size[1]))
            print("Enter size of second matrix:", end="")
            size = input().split(" ")
            print("Enter second matrix:")
            second_matrix = enter_mat(int(size[0]), int(size[1]))
            if choice == 1:
                matrix = add_mat(first_matrix, second_matrix)
            elif choice == 3:
